    ...
    <Flex direction="column">
      ...
      <Flex direction="row" gaps="large" className="w-full">
        <Flex direction="column" className="grow">
          ...
          {/* Residual Value */}
          <div className="calculator-row">
            <label htmlFor="residualValue" className="block font-medium mb-1">
              Jäännösarvo % {texts.residualValue}
            </label>
            <Flex gaps="small">
              <input
                id="residualValue"
                ...
                aria-label={texts.residualValue}
              />
              <input
                type="number"
                min={12}
        ...
        >
          ...
          <div className="flex flex-col">
            {texts.monthlyFee}:<span className="font-bold text-2xl">{monthlyPayment} €</span>
          </div>
