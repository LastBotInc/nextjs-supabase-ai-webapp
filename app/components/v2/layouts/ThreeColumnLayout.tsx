...
/**
 * ThreeColumnLayout is a layout component that renders hree columns side by side. It wraps both children with containers that set gaps and spacing
 ...
 * @param children - The children of the layout. There must be three children.
 * @param columnWidths - The widths of the columns as responsive a SizeDefinition object.
 * @param rest - The rest of the props.
 * @returns A div element with Three columns.
 */
export function ThreeColumnLayout({
  children,
  columnWidths,
  ...rest
}: Omit<FlexLayoutProps, "children"> & { children: [ReactNode, ReactNode, ReactNode] }) {
  return (
