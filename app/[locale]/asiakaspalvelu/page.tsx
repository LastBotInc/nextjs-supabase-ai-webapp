...
export default async function CustomerServicePage({ params }: { params: { locale: string } }) {
  ...
  const supportCategories = [
    {
      title: t('categories.leasing.title'),
      description: t('categories.leasing.description'),
    ...
    {
      title: t('categories.accounts.title'),
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-16">
            ...
            <div className="bg-beige p-8 rounded-lg">
              ...
              <div className="mt-6">
                <Button 
                  size="default"
                  className="bg-kupari hover:bg-kupari/90 text-white px-6 py-3 rounded-md"
                  asChild
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {supportCategories.map((category, index) => (
              ...
              >
                ...
                <Link 
                  href="#" 
                  className="text-kupari font-medium flex items-center hover:underline"
                >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-piki mb-6">
              ...
              <form className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  size="lg" 
                  className="w-full bg-piki hover:bg-piki/90 text-white py-3"
                >
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button 
                ...
                asChild
              >
                <Link href={`/${locale}/fleet-management`}>
                  {t('cta.fleetButton')}
                </Link>
              </Button>
              <Button 
