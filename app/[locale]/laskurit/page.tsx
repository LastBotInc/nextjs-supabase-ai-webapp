        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col justify-center space-y-4">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">{t("hero.heading")}</h1>
              <p className="max-w-[600px] text-white/90 md:text-xl">{t("hero.subheading")}</p>
            </div>
      ...
      <section className="py-12 bg-beige">
        <div className="container px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-700 mb-8">{t("intro.description")}</p>
            <Button
            ...
            >
              <a href="#calculator">
                {" "}
                {/* Simple anchor link for server component */}
      ...
      <section id="calculator" className="py-16">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{t("calculator.title")}</h2>
            <p className="text-gray-700 max-w-3xl mx-auto">{t("calculator.description")}</p>
          </div>
          ...
          <div className="mt-16 text-center">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto mb-8">{t("cta.description")}</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button variant="outline" asChild>
                ...
                <Link href={`/${locale}/leasing-solutions`}>{t("cta.learnMoreButton")}</Link>
              </Button>
            </div>
          </div>
        </div>
